...
/*-----------------------------------------------
              @(target):= _distToTree.so
  ------------------------------------------------*/
#if PY_VERSION_HEX >= 0x03000000
#  define SWIG_init    PyInit__distToTree

#else
#  define SWIG_init    init_distToTree

#endif
#define SWIG_name    "_distToTree"
...
extern "C" {
#endif
SWIGINTERN PyObject *_wrap_distToTree(PyObject *SWIGUNUSEDPARM(self), PyObject *args) {
  ...
  if (!PyArg_ParseTuple(args,(char *)"OO:distToTree",&obj0,&obj1)) SWIG_fail;
  {
    npy_intp size[1] = {
      -1 
    };
  ...
  distToTree(arg1,arg2,arg3,arg4,arg5);
...
static PyMethodDef SwigMethods[] = {
	 ...
	 { (char *)"distToTree", _wrap_distToTree, METH_VARARGS, NULL},
	 { NULL, NULL, 0, NULL }
};
